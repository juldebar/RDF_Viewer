...
<s:iterator value="results">
        ...
        <div class="row-fluid">
            <div class="span4">
                <div class="thumbnail">
                    ...
                    <img alt="300x200" data-src="holder.js/300x200" style="width: auto; height: 200px;" src="<s:property value="picUrl"/>">
                </div>
            </div>
            <div class="span8">
                <div class="caption">
                    <s:if test="description.literal != null"> 
                        ...
                        <div class="comment"><s:property value="description.literal"/></div>
                    </s:if>
                    <s:else>
                        Aucune donnée
                    </s:else>
    ...
    <div class="modal-footer">
        <a href="<s:property value="uri.uri"/>" target="_blank" class="btn btn-primary">En savoir plus</a>  
    </div>
</s:iterator>
