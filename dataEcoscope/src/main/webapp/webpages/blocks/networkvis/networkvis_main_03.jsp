...
<%-- PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> PREFIX owl: <http://www.w3.org/2002/07/owl#> CONSTRUCT  { <<s:property value="resourceUri"/>> rdf:type owl:Thing . ?s ?p <<s:property value="resourceUri"/>> . ?s rdf:type owl:Thing . } WHERE {	OPTIONAL { ?s ?p <<s:property value="resourceUri"/>> . FILTER (?p = rdf:type) }} --%>


<s:i18n name="org.ird.crh.ecoscope.kb.strutsactions.ShowResource">

	<sj:div id="network_vis_02" style="background-color: white; padding: 10px;" cssClass="kb-corner-radius-c1">
		...
		<object codetype="application/java" classid="java:org.ird.crh.ecoscope.prefuse.applet.EcoPrefuseApplet" archive="webpages/tools/prefuseSparql_20091210.jar" width="360" height="280">
			...
			<param name="inferenceEngine" value="OWL_MEM_RDFS_INF"/>
